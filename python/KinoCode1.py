...
# 不要カラムの削除と並べ替え
df = df[['weekday', 'High', 'Low', 'Open', 'Close', 'Close_ratio', 'Body','NikkiClose','Up']]
print(df)
...
説明変数のカラムは'weekday', 'High', 'Low', 'Open', 'Close', 'Close_ratio', 'Body'を目的変数のカラムは'Up'になります。
...
X_train = df_train[['weekday', 'High', 'Low',
                    'Open', 'Close', 'Close_ratio', 'Body','NikkiClose']]
y_train = df_train['Up']
