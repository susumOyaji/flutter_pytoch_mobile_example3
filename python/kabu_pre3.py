...
try:
    #df = web.DataReader(f'{code}.T', 'yahoo', start, end).values.tolist()
...
df.to_csv(df, columns=['Date','Open', 'High','Low','Close','sma01','sma02','sma03','Volume','Adj Close'])
print(dfinc)
...
# CSVファイルから得微量作成
#for file in files:
temp = pd.read_csv(df, header=0, encoding='cp932')
